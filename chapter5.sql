---------chapter5:Basic Math and Stats with SQL--- 
...
SELECT geo_name,
       ...
       p0010003 + p0010004 AS "Total White and Black" --Adding columns
FROM us_counties_2010;
...
SELECT geo_name,
       state_us_abbreviation AS "st",
       round((CAST(p0010006 AS numeric(8,1)) / p0010001) * 100,1) AS "pct_asian"
FROM us_counties_2010
...
SELECT geo_name,
       ...
       round((CAST (p0010005 AS numeric(8,1)) / p0010001) * 100,1)
