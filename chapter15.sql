------CHAPTER15;Views,Functions and triggers----
 
-- view is a virtual table you can create dynamically using a saved query 
...
CREATE OR REPLACE VIEW employees_tax_dept AS
     ...
     WHERE dept_id = 1
     ORDER BY emp_id
     WITH LOCAL CHECK OPTION;---WHATdoes this mean
	 
SELECT * 
FROM employees_tax_dept;

--inserts via the employees_tax_dept view
...
UPDATE employees_tax_dept
SET salary = 100000--SALARY IS NOT IN THE VIEW
WHERE emp_id = 5;
...
RETURNS void AS $$---what do the dollar signs mean??
BEGIN
    UPDATE teachers
    SET personal_days =
