...
---------chapter8:Extracting information by grouping and summarizing-- 
...
FROM 'C:\Users\Kundani Nemugumoni\Documents\Code College\BootCamp\1_SQL\2_SQL Solutions\Chapter_08\pls_fy2014_pupld14a.csv'
...
FROM 'C:\Users\Kundani Nemugumoni\Documents\Code College\BootCamp\1_SQL\2_SQL Solutions\Chapter_08\pls_fy2009_pupld09a.csv'
WITH (FORMAT CSV, HEADER);
...
--Aggregating Data Using GROUP BY------What is the difference between SELECT DISTINCT AND GROUP BY
SELECT city
FROM pls_fy2014_pupld14a
GROUP BY city
--ORDER BY stabr; 
